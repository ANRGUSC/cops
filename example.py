...
#Add edges to graph
connectivity_edges = [0, 1] #directed connectivity path (one way)
transition_edges = [0, 1]   #directed transition path (one way)
G.add_transition_path(transition_edges)
G.add_connectivity_path(connectivity_edges)

#Add edges to graph
connectivity_edges = [1, 2, 3, 4, 5] #directed connectivity path (one way)
transition_edges = [1, 2, 3, 4, 5]   #directed transition path (one way)
G.add_transition_path(transition_edges)
G.add_connectivity_path(connectivity_edges)

#Add edges to graph
connectivity_edges = [4, 6, 7, 8] #directed connectivity path (one way)
transition_edges = [4, 6, 7, 8]   #directed transition path (one way)
G.add_transition_path(transition_edges)
G.add_connectivity_path(connectivity_edges)

#Add edges to graph
connectivity_edges = [1, 9, 10, 11, 12, 13] #directed connectivity path (one way)
transition_edges = [1, 9, 10, 11, 12, 13]   #directed transition path (one way)
G.add_transition_path(transition_edges)
G.add_connectivity_path(connectivity_edges)

#Add edges to graph
connectivity_edges = [9, 14, 15, 12] #directed connectivity path (one way)
transition_edges = [9, 14, 15, 12]   #directed transition path (one way)
G.add_transition_path(transition_edges)
G.add_connectivity_path(connectivity_edges)

#Add edges to graph
connectivity_edges = [1, 16, 17, 18, 19, 20, 21, 22, 23, 24] #directed connectivity path (one way)
transition_edges = [1, 16, 17, 18, 19, 20, 21, 22, 23, 24]   #directed transition path (one way)
G.add_transition_path(transition_edges)
G.add_connectivity_path(connectivity_edges)

#Add edges to graph
connectivity_edges = [8, 10] #directed connectivity path (one way)
G.add_connectivity_path(connectivity_edges)
#Add edges to graph
connectivity_edges = [15, 24] #directed connectivity path (one way)
G.add_connectivity_path(connectivity_edges)
...
node_positions = {0: (0,0), 1: (0,1), 2: (-2,1), 3: (-2,2), 4: (-3,2), 5: (-3,1),
                ...
                16: (1.5,1), 17: (2.5,1.3), 18: (4,1.3), 19: (5,1.3), 20: (5,2), 21: (4,3), 22: (5,3), 23: (5,4), 24: (3.5,4)}
